...
${OBJECTDIR}/another_file.o: another_file.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/another_file.o another_file.c

${OBJECTDIR}/auto_ex.o: auto_ex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/auto_ex.o auto_ex.c

${OBJECTDIR}/diceroll.o: diceroll.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/diceroll.o diceroll.c

${OBJECTDIR}/dyn_arr.o: dyn_arr.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dyn_arr.o dyn_arr.c

${OBJECTDIR}/forc99.o: forc99.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/forc99.o forc99.c
...
${OBJECTDIR}/hiding.o: hiding.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hiding.o hiding.c

${OBJECTDIR}/loc_stat.o: loc_stat.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/loc_stat.o loc_stat.c
...
${OBJECTDIR}/manydice.o: manydice.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/manydice.o manydice.c

${OBJECTDIR}/parta.o: parta.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parta.o parta.c

${OBJECTDIR}/partb.o: partb.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/partb.o partb.c

${OBJECTDIR}/r_drive0.o: r_drive0.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/r_drive0.o r_drive0.c

${OBJECTDIR}/r_drive1.o: r_drive1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/r_drive1.o r_drive1.c

${OBJECTDIR}/rand0.o: rand0.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rand0.o rand0.c

${OBJECTDIR}/regis_ex.o: regis_ex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/regis_ex.o regis_ex.c

${OBJECTDIR}/s_and_r.o: s_and_r.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/s_and_r.o s_and_r.c

${OBJECTDIR}/static_ext_ex.o: static_ext_ex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/static_ext_ex.o static_ext_ex.c

${OBJECTDIR}/static_int_ex.o: static_int_ex.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/static_int_ex.o static_int_ex.c

${OBJECTDIR}/static_no_link.o: static_no_link.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/static_no_link.o static_no_link.c

${OBJECTDIR}/where.o: where.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/where.o where.c
